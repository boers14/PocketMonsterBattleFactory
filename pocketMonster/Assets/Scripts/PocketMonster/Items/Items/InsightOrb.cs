...
public class InsightOrb : PocketMonsterItem
{
    ...
    public override void SetStats()
    {
        ...
        everyTurn = true;
        name = "Insight Orb";
        itemDescription = "Boosts the damage done by special moves by 5% every turn. This effects stacks till a max of a 50% boost. The amplified power" +
            " resets on switch.";

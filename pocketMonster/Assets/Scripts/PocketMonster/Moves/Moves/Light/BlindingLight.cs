...
public class BlindingLight : PocketMonsterMoves
{
    public override void SetMoveStats()
    {
        ...
        moveDescription = "Has a 50% chance to nearsight the opposing pocketmonster. 10 power points.";
    }
    ...
    public override void GrantSideEffect(PocketMonster ownPocketMonster, PocketMonster opponentPocketMonster, float damageDone, InBattleTextManager inBattleTextManager, PlayerBattle player)
    {
        ...
        {
            opponentPocketMonster.currentStatus = PocketMonster.StatusEffects.Nearsighted;
            inBattleTextManager.QueMessage(opponentPocketMonster.stats.name + " got nearsighted from the attack.", false, false, false, false);
        }
    }
}
